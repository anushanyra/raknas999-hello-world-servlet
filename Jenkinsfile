...
// for display purposes
      ...
      git 'https://github.com/anushanyra/raknas999-hello-world-servlet.git'
...
post {
        success {
            mail to:"anushagadam0@gmail.com", subject:"SUCCESS: ${currentBuild.fullDisplayName}", body: "Build success"
        }
        failure {
